...
### Config File ###
AmassConfig=./config.ini    #Edit path to your config.ini
SubfinderConfig=./provider-config.yaml	#Edit path to your provider-config.yaml
...
webcrawler
nucleiScan
echo -e "${BRed}All Scans Completed.........."
